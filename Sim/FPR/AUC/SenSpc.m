...
T_list   = [100 200 600 1200 1500 2000]; %Oi! before adding 1500 and 2000, becareful that the size(mts,1) is only 1200
...
%----SAVE
SaveDir = ['/storage/essicd/data/HCP/Soroosh/ACAnal/MESim/FPR/SenSpc/R_' TVFlag '_' num2str(upb) '-' num2str(downb) '/'];
if exist(SaveDir,'dir')~=7; mkdir(SaveDir); end

save([SaveDir '/Sen_Spec_t' num2str(Tp) '_' num2str(SubID) '_' num2str(i_cnt) '_' TVFlag '_r' num2str(rho_u) '-' num2str(rho_d) '_JustZs.mat'],'Z','rCovMat');
disp('Done!')
%---DONE
