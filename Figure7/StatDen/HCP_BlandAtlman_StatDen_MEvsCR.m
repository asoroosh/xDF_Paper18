%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Figure 7:
% Plots changes on the local measures of Statistically thresholded 
...
cnt_g=1; spc=1;
fh = figure('position',[50,500,600,500]);
hold on; box on;    
cnt_v=1;
for TarVar = VarList
    cnt_a=1;
    for Atlas = AtlasList
            ...
            for s_cnt = 1:numel(SubList)
                ...
                %title([VarList2Show{cnt_v}],'fontsize',12,'interpreter','latex')
                %__________________________________________________________________
...
writetable(array2table(AllDiffRate*100,'VariableNames',AtlasList,'RowNames',VarList),'MEvsCR.csv')

set(gcf,'color','w');

export_fig(fh,'Local_StatDen_MEvsCR.pdf')
